...
internal class GenGlobalToneCurve2
{
    ...
    public void CalcGammaLeft()
    {
        ...
        {
            num = m_genIndexNor[i];
            num7 = !(num < num2) ? num4 * Math.Pow((num + num5 / 1024.0) / (1.0 + num5 / 1024.0), num6 / 1024.0) : num4 * (num / num3);
    ...
    public void CalcBlending()
    {
        ...
        {
            num7 = m_genIndex[i];
            num8 = Math.Tanh(num5 / 1024.0 * (Math.Log(num7 / 32.0 * 1024.0 / num2 + 1E-15, Math.E) + 1.0) / (Math.Log(1024.0 / num2) + 1.0) - num6 / 1024.0);
            num9 = num * ((num3 + num4) / 2048.0 - (num3 - num4) / 2048.0 * num8);
