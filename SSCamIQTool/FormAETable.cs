...
public class FormAETable : Form
{
    ...
    public FormAETable(GuiGroup group, IQComm comm, string itemTag, bool bAW)
    {
        ...
        if (num5 > m_nDefaultFormWdith)
        {
            Width = m_nDefaultFormWdith;
        }
        else if (num5 < labelShowTableTitle.Width + labelShowTableTitle.Location.X * 2)
        {
    ...
    private void btnImportTable_Click(object sender, EventArgs e)
    {
        ...
        openFileDialog.Filter = "data file (*.lut)|*.lut";
