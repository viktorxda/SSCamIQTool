...
public class YUVGamma : UserControl
{
    ...
    private int m_nYLength = 256;

    private int m_nYMax = 1024;

    private int m_nUVLength = 128;

    private int m_nUVMax = 512;

    private List<Point> m_ptFeatureY = new List<Point>();

    private List<Point> m_ptFeatureU = new List<Point>();

    private List<Point> m_ptFeatureV = new List<Point>();
    ...
    {
        getYGammaArray(out var pGammaY);
        getUGammaArray(out var pGammaU);
        getVGammaArray(out var pGammaV);
        if (OpMode == 0 && GammaEnable == 1)
        {
    ...
    {
        GetGammaWithOB(m_nYMax, m_nYMax, 0m, m_nYLength, out var pGammaArray);
        GetGammaWithOB(m_nUVMax, m_nUVMax, 0m, m_nUVLength, out var pGammaArray2);
        ...
        if (pGammaArray != null)
        {
            ...
            {
                chartY.Series["SeriesGammaY"].Points.AddXY(i, pGammaArray[i].Y);
            }
        ...
        if (pGammaArray2 != null)
        {
            ...
            {
                chartUV.Series["SeriesGammaU"].Points.AddXY(j, pGammaArray2[j].Y);
                chartUV.Series["SeriesGammaU"].Points[j].Color = Color.FromArgb(0, 0, j * 2);
                chartUV.Series["SeriesGammaUr"].Points.AddXY(-j, -pGammaArray2[j].Y);
                chartUV.Series["SeriesGammaUr"].Points[j].Color = Color.FromArgb(2 * j, 2 * j, 0);
                chartUV.Series["SeriesGammaV"].Points.AddXY(j, pGammaArray2[j].Y);
                chartUV.Series["SeriesGammaV"].Points[j].Color = Color.FromArgb(2 * j, 0, 2 * j);
                chartUV.Series["SeriesGammaVr"].Points.AddXY(-j, -pGammaArray2[j].Y);
    ...
    private void chartY_MouseMove(object sender, MouseEventArgs e)
    {
        ...
        if (m_chartSelectY && axisValuesFromMouse != null)
        {
            ...
            {
                chartY.Series["SeriesFeatureY"].Points.AddXY(m_ptFeatureY[i].X, m_ptFeatureY[i].Y);
            }
        }
    }
    ...
    private void chartUV_MouseMove(object sender, MouseEventArgs e)
    {
        ...
        if (m_chartSelectU && axisValuesFromMouse != null)
        {
            ...
            {
                chartUV.Series["SeriesFeatureU"].Points.AddXY(m_ptFeatureU[i].X, m_ptFeatureU[i].Y);
            }
        }
        if (m_chartSelectV && axisValuesFromMouse != null)
        {
            ...
            {
                chartUV.Series["SeriesFeatureV"].Points.AddXY(m_ptFeatureV[j].X, m_ptFeatureV[j].Y);
            }
        }
    }
    ...
    {
        Series pCurve = chartY.Series["SeriesGammaY"];
        Point ptSelect = new Point((int)numUpDown_Y_X.Value, (int)numUpDown_Y_Y.Value);
    ...
    {
        Series pCurve = chartUV.Series["SeriesGammaU"];
        Point ptSelect = new Point((int)numUpDown_U_X.Value, (int)numUpDown_U_Y.Value);
    ...
    {
        Series pCurve = chartUV.Series["SeriesGammaV"];
        Point ptSelect = new Point((int)numUpDown_V_X.Value, (int)numUpDown_V_Y.Value);
        AddFeaturePointByXY(pCurve, m_ptFeatureV, ptSelect, ref m_nFeatureIdxV);
        chartUV.Series["SeriesFeatureV"].Points.Clear();
        for (int i = 0; i < m_ptFeatureV.Count; i++)
        {
            chartUV.Series["SeriesFeatureV"].Points.AddXY(m_ptFeatureV[i].X, m_ptFeatureV[i].Y);
        }
    ...
    private void btnLoad_Click(object sender, EventArgs e)
    {
        ...
        chartY.Series["SeriesFeatureY"].Points.AddXY(0.0, chartY.Series["SeriesGammaY"].Points[0].YValues[0]);
        chartY.Series["SeriesFeatureY"].Points.AddXY(m_nYLength - 1, chartY.Series["SeriesGammaY"].Points[m_nYLength - 1].YValues[0]);
        m_ptFeatureU.Clear();
        ...
        chartUV.Series["SeriesFeatureU"].Points.AddXY(0.0, chartUV.Series["SeriesGammaU"].Points[0].YValues[0]);
        chartUV.Series["SeriesFeatureU"].Points.AddXY(m_nUVLength - 1, chartUV.Series["SeriesGammaU"].Points[m_nUVLength - 1].YValues[0]);
        m_ptFeatureV.Clear();
        ...
        chartUV.Series["SeriesFeatureV"].Points.AddXY(0.0, chartUV.Series["SeriesGammaV"].Points[0].YValues[0]);
        chartUV.Series["SeriesFeatureV"].Points.AddXY(m_nUVLength - 1, chartUV.Series["SeriesGammaV"].Points[m_nUVLength - 1].YValues[0]);
        SaveGammaValue_temp();
        streamReader.Close();
    }
    ...
    private void ResetCurveY(string strGammaName)
    {
        ...
        if (pGammaArray != null)
        {
            ...
            {
                series.Points.AddXY(ptFeatureY[j].X, ptFeatureY[j].Y);
            }
        }
    }
    ...
    {
        int num = 0;
        GetGammaWithOB(m_nUVMax, m_nUVMax, 0m, m_nUVLength, out var pGammaArray);
        if (pGammaArray != null)
        {
            for (num = 0; num < pGammaArray.Length; num++)
            {
