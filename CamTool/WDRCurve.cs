...
public class WDRCurve : UserControl
{
    ...
    private void chartGamma_MouseMove(object sender, MouseEventArgs e)
    {
        try
        {
            ...
            if (m_chartSelectRGB && axisValuesFromMouse != null)
            {
                ...
                {
                    _ = series3.Points.AddXY(m_ptFeatureRControl[l].X, m_ptFeatureRControl[l].Y);
                }
                clearControlLine();
                drawControlLine(m_ptFeatureR, m_ptFeatureRControl);
                _ = chartGamma.Series["SeriesGammaR"];
                ...
                {
                    _ = chartGamma.Series["SeriesFeatureR"].Points.AddXY(m_ptFeatureR[m].X, m_ptFeatureR[m].Y);
                    _ = chartGamma.Series["SeriesFeatureG"].Points.AddXY(m_ptFeatureR[m].X, m_ptFeatureR[m].Y);
                    _ = chartGamma.Series["SeriesFeatureB"].Points.AddXY(m_ptFeatureR[m].X, m_ptFeatureR[m].Y);
                }
            }
            ...
            {
                _ = series4.Points.AddXY(m_ptFeatureRControl[n].X, m_ptFeatureRControl[n].Y);
            }
    ...
    private void btnSave_Click(object sender, EventArgs e)
    {
        ...
        stream.Close();
        _ = MessageBox.Show("Save WDRCurve Data OK");
    }
