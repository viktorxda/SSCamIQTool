...
public class FormGlobalToneGammaVer1 : Form
{
    ...
    private readonly GenGlobalToneCurve1 m_objGlobalTone = new();
            ...
            case 1:
                {
                    ...
                    for (int i = 0; i < NumberOfGroup; i++)
                    {
                        ...
                        GenGlobalToneCurve1 genGlobalToneCurve = new()
                        {
                            m_genParam = array
                        };
                    ...
                    GenGlobalToneCurve1 genGlobalToneCurve2 = new()
                    {
                        m_genParam = array
                    };
                    ...
                    if (OpMode == 1)
                    {
                        for (int n = 0; n < 33; n++)
                        {
                            ...
                            _ = chartGamma.Series["SeriesGamma"].Points.AddXY(n, ynode_Manual[n]);
                            _ = chartGamma.Series["SeriesGammaFeature"].Points.AddXY(n, ynode_Manual[n]);
                    ...
                    else
                    {
                        for (int num = 0; num < 33; num++)
                        {
                            ...
                            _ = chartGamma.Series["SeriesGamma"].Points.AddXY(num, ynode_Auto[(Index * GammaNumber) + num]);
                            _ = chartGamma.Series["SeriesGammaFeature"].Points.AddXY(num, ynode_Auto[(Index * GammaNumber) + num]);
