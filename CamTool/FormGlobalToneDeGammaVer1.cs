...
public class FormGlobalToneDeGammaVer1 : Form
{
    ...
    private readonly GenGlobalToneCurve2 m_objGlobalTone = new();

    private readonly long[] GlobalToneParam_Auto = new long[144];
    ...
    private void RecomputeGurve(int all)
    {
        if (all == 1)
        {
            ...
            for (int i = 0; i < NumberOfGroup; i++)
            {
                ...
                GenGlobalToneCurve2 genGlobalToneCurve = new()
                {
                    m_genParam = array
                };
            ...
            GenGlobalToneCurve2 genGlobalToneCurve2 = new()
            {
                m_genParam = array
            };
            ...
            if (OpMode == 1)
            {
                for (int n = 0; n < 33; n++)
                {
                    ...
                    _ = chartDeGamma.Series["SeriesDeGamma"].Points.AddXY(n, ynode_Manual[n]);
                    _ = chartDeGamma.Series["SeriesDeGammaFeature"].Points.AddXY(n, ynode_Manual[n]);
            ...
            else
            {
                for (int num = 0; num < 33; num++)
                {
                    ...
                    _ = chartDeGamma.Series["SeriesDeGamma"].Points.AddXY(num, ynode_Auto[(Index * DeGammaNumber) + num]);
                    _ = chartDeGamma.Series["SeriesDeGammaFeature"].Points.AddXY(num, ynode_Auto[(Index * DeGammaNumber) + num]);
    ...
    {
        FormGlobalToneSetParam formGlobalToneSetParam = new()
        {
            Text = "FormCurve2SetParam"
        };
        ...
        _ = formGlobalToneSetParam.ShowDialog();
