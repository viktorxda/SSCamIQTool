...
internal class GenGlobalToneCurve1
{
    ...
    public void CalcGammaLeft()
    {
        ...
        for (int i = 0; i < 33; i++)
        {
            ...
            double num7 = !(num < num2 / num3) ? num4 * ((Math.Pow(num, 1024.0 / num6) * (1.0 + (num5 / 1024.0))) - (num5 / 1024.0)) : num4 * (num * num3);
    ...
    public void CalcGammaRight()
    {
        ...
        {
            double num = m_genIndexNor[i];
            double num7 = !(num < num2 / num3) ? num4 * ((Math.Pow(num, 1024.0 / num5) * (1.0 + (num6 / 1024.0))) - (num6 / 1024.0)) : num4 * (num * num3);
    ...
    public void CalcBlending()
    {
        ...
        for (int i = 0; i < 33; i++)
        {
            double num5 = m_genIndex[i];
            double num8 = num * (((num2 + num3) / 2048.0) - ((num2 - num3) / 2048.0 * Math.Tanh((num4 / 1024.0 * (Math.Log((num5 / 32.0 * 1024.0 / num6) + 1E-15, Math.E) + 1.0) / (Math.Log(1024.0 / num6, Math.E) + 1.0)) - (num7 / 1024.0))));
