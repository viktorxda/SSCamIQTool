...
public class RGBGamma : UserControl
{
    ...
    private readonly int m_nGammaLength = 256;

    private readonly short m_nGammaValueMax;

    private readonly List<Point> m_ptFeatureR = new();

    private readonly List<Point> m_ptFeatureG = new();

    private readonly List<Point> m_ptFeatureB = new();

    private readonly List<Point> m_ptFeatureRControl = new();

    private readonly List<Point> m_ptFeatureGControl = new();

    private readonly List<Point> m_ptFeatureBControl = new();
    ...
    public void SaveGammaValue_temp()
    {
        ...
        getGreenGammaArray(out long[] pGammaG);
        getBlueGammaArray(out long[] pGammaB);
        if (OpMode == 0 && GammaEnable == 1)
        {
    ...
    public void InitChart()
    {
        ...
        if (pGammaArray != null)
        {
            ...
            {
                _ = chartGamma.Series["SeriesGammaR"].Points.AddXY(i, pGammaArray[i].Y);
                _ = chartGamma.Series["SeriesGammaG"].Points.AddXY(i, pGammaArray[i].Y);
                _ = chartGamma.Series["SeriesGammaB"].Points.AddXY(i, pGammaArray[i].Y);
            }
        ...
        for (int j = 0; j < 512; j++)
        {
            _ = chartGamma.Series.Add("SeriesBezierControl" + j);
    ...
    public void InitBezierControl(Series seiresRLine, Series seiresRPoints, Series seiresControl, List<Point> m_ptFeatureR, List<Point> m_ptFeatureRControl)
    {
        ...
        {
            _ = seiresControl.Points.AddXY(m_ptFeatureRControl[j].X, m_ptFeatureRControl[j].Y);
        }
        clearControlLine();
        for (int k = 0; k < m_ptFeatureRControl.Count; k++)
        {
            ...
            if (k % 2 == 0)
            {
                ...
                {
                    num13 = (int)((a * l) + b);
                    _ = chartGamma.Series["SeriesBezierControl" + k].Points.AddXY(l, num13);
                }
            }
            else
            {
                ...
                {
                    num13 = (int)((a * m) + b);
                    _ = chartGamma.Series["SeriesBezierControl" + k].Points.AddXY(m, num13);
                }
            }
        }
    }
    ...
    public void drawControlLine(List<Point> m_ptFeature, List<Point> m_ptFeatureControl)
    {
        for (int i = 0; i < m_ptFeatureControl.Count; i++)
        {
            ...
            if (i % 2 == 0)
            {
                ...
                {
                    num5 = (int)((a * j) + b);
                    _ = chartGamma.Series["SeriesBezierControl" + i].Points.AddXY(j, num5);
                }
            }
            else
            {
                ...
                {
                    num5 = (int)((a * k) + b);
                    _ = chartGamma.Series["SeriesBezierControl" + i].Points.AddXY(k, num5);
                }
            }
        }
    }
    ...
    protected void BezierCurveBelongModify(int nFeatureIdx, Series seiresCurve, List<Point> ptFeature, ref double choosepointfinalY)
    {
        ...
        if (nFeatureIdx >= 1 && nFeatureIdx < ptFeature.Count - 1)
        {
            ...
            {
                num8 = (i - num) / (num3 - num);
                double num7 = (int)(((1.0 - num8) * (1.0 - num8) * num4) + (2.0 * (1.0 - num8) * num8 * num5) + (num8 * num8 * num6));
    ...
    private void chartGamma_MouseMove(object sender, MouseEventArgs e)
    {
        try
        {
            ...
            if (m_chartSelectR && axisValuesFromMouse != null)
            {
                ...
                {
                    _ = series.Points.AddXY(m_ptFeatureRControl[i].X, m_ptFeatureRControl[i].Y);
                }
                clearControlLine();
                drawControlLine(m_ptFeatureR, m_ptFeatureRControl);
                ...
                {
                    _ = chartGamma.Series["SeriesFeatureR"].Points.AddXY(m_ptFeatureR[j].X, m_ptFeatureR[j].Y);
                }
            }
            if (m_chartSelectR_C && axisValuesFromMouse != null)
            {
                ...
                for (int k = 0; k < m_ptFeatureRControl.Count; k++)
                {
                    _ = series2.Points.AddXY(m_ptFeatureRControl[k].X, m_ptFeatureRControl[k].Y);
                }
            ...
            if (m_chartSelectG && axisValuesFromMouse != null)
            {
                ...
                {
                    _ = series3.Points.AddXY(m_ptFeatureGControl[l].X, m_ptFeatureGControl[l].Y);
                }
                clearControlLine();
                drawControlLine(m_ptFeatureG, m_ptFeatureGControl);
                ...
                {
                    _ = chartGamma.Series["SeriesFeatureG"].Points.AddXY(m_ptFeatureG[m].X, m_ptFeatureG[m].Y);
                }
            }
            if (m_chartSelectG_C && axisValuesFromMouse != null)
            {
                ...
                {
                    _ = series4.Points.AddXY(m_ptFeatureGControl[n].X, m_ptFeatureGControl[n].Y);
                }
            ...
            if (m_chartSelectB && axisValuesFromMouse != null)
            {
                ...
                {
                    _ = series5.Points.AddXY(m_ptFeatureBControl[num89].X, m_ptFeatureBControl[num89].Y);
                }
                clearControlLine();
                drawControlLine(m_ptFeatureB, m_ptFeatureBControl);
                ...
                {
                    _ = chartGamma.Series["SeriesFeatureB"].Points.AddXY(m_ptFeatureB[num114].X, m_ptFeatureB[num114].Y);
                }
            }
            if (m_chartSelectB_C && axisValuesFromMouse != null)
            {
                ...
                {
                    _ = series6.Points.AddXY(m_ptFeatureBControl[num122].X, m_ptFeatureBControl[num122].Y);
                }
            ...
            if (m_chartSelectRGB && axisValuesFromMouse != null)
            {
                ...
                {
                    _ = series7.Points.AddXY(m_ptFeatureRControl[num136].X, m_ptFeatureRControl[num136].Y);
                }
                clearControlLine();
                drawControlLine(m_ptFeatureR, m_ptFeatureRControl);
                _ = chartGamma.Series["SeriesGammaR"];
                ...
                {
                    _ = chartGamma.Series["SeriesFeatureR"].Points.AddXY(m_ptFeatureR[num161].X, m_ptFeatureR[num161].Y);
                    _ = chartGamma.Series["SeriesFeatureG"].Points.AddXY(m_ptFeatureR[num161].X, m_ptFeatureR[num161].Y);
                    _ = chartGamma.Series["SeriesFeatureB"].Points.AddXY(m_ptFeatureR[num161].X, m_ptFeatureR[num161].Y);
                }
            }
            ...
            {
                _ = series8.Points.AddXY(m_ptFeatureRControl[num169].X, m_ptFeatureRControl[num169].Y);
            }
    ...
    private void RGBsameLineSet()
    {
        ...
        {
            _ = chartGamma.Series["SeriesGammaG"].Points.AddXY(i, chartGamma.Series["SeriesGammaR"].Points[i].YValues[0]);
            _ = chartGamma.Series["SeriesGammaB"].Points.AddXY(i, chartGamma.Series["SeriesGammaR"].Points[i].YValues[0]);
        }
        ...
        for (int j = 0; j < m_ptFeatureRControl.Count; j++)
        {
            _ = chartGamma.Series["SeriesControlG"].Points.AddXY(m_ptFeatureRControl[j].X, m_ptFeatureRControl[j].Y);
            _ = chartGamma.Series["SeriesControlB"].Points.AddXY(m_ptFeatureRControl[j].X, m_ptFeatureRControl[j].Y);
        }
    ...
    private void RGBsameLineBack()
    {
        for (int i = 0; i < m_ptFeatureR.Count; i++)
        {
            ...
            _ = chartGamma.Series["SeriesFeatureG"].Points.AddXY(m_ptFeatureR[i].X, m_ptFeatureR[i].Y);
            _ = chartGamma.Series["SeriesFeatureB"].Points.AddXY(m_ptFeatureR[i].X, m_ptFeatureR[i].Y);
        }
        chartGamma.Series["SeriesGammaG"].Points.Clear();
        chartGamma.Series["SeriesGammaB"].Points.Clear();
        for (int j = 0; j < m_nGammaLength; j++)
        {
            _ = chartGamma.Series["SeriesGammaG"].Points.AddXY(j, chartGamma.Series["SeriesGammaR"].Points[j].YValues[0]);
            _ = chartGamma.Series["SeriesGammaB"].Points.AddXY(j, chartGamma.Series["SeriesGammaR"].Points[j].YValues[0]);
        }
        ...
        for (int k = 0; k < m_ptFeatureRControl.Count; k++)
        {
            ...
            _ = chartGamma.Series["SeriesControlG"].Points.AddXY(m_ptFeatureRControl[k].X, m_ptFeatureRControl[k].Y);
            _ = chartGamma.Series["SeriesControlB"].Points.AddXY(m_ptFeatureRControl[k].X, m_ptFeatureRControl[k].Y);
        }
    ...
    {
        _ = chartGamma.Series["SeriesFeatureR"].Points.AddXY(numUpDown_Red_X.Value, chartGamma.Series["SeriesGammaR"].Points[(int)numUpDown_Red_X.Value].YValues[0]);
    }
    ...
    private void btnRedset_Click(object sender, EventArgs e)
    {
        ...
        Series seiresControl = chartGamma.Series["SeriesControlR"];
        Point ptSelect = new((int)numUpDown_Red_X.Value, (int)numUpDown_Red_Y.Value);
        AddFeaturePointByXY(series, seiresPointsfor_c, seiresControl, m_ptFeatureR, ptSelect, ref m_nFeatureIdxR);
        chartGamma.Series["SeriesFeatureR"].Points.Clear();
        for (int i = 0; i < m_ptFeatureR.Count; i++)
        {
            _ = chartGamma.Series["SeriesFeatureR"].Points.AddXY(m_ptFeatureR[i].X, m_ptFeatureR[i].Y);
        }
    ...
    private void btnGreenset_Click(object sender, EventArgs e)
    {
        ...
        Point ptSelect = new((int)numUpDown_Green_X.Value, (int)numUpDown_Green_Y.Value);
        ...
        {
            _ = chartGamma.Series["SeriesFeatureG"].Points.AddXY(m_ptFeatureG[i].X, m_ptFeatureG[i].Y);
        }
    ...
    private void btnBlueset_Click(object sender, EventArgs e)
    {
        ...
        Point ptSelect = new((int)numUpDown_Blue_X.Value, (int)numUpDown_Blue_Y.Value);
        ...
        {
            _ = chartGamma.Series["SeriesFeatureB"].Points.AddXY(m_ptFeatureB[i].X, m_ptFeatureB[i].Y);
        }
    ...
    public void setRedGammaArray(long[] pGamma, int index)
    {
        ...
        {
            _ = chartGamma.Series["SeriesGammaR"].Points.AddXY(num, pGamma[i]);
            num++;
        }
        Series seiresPoints = chartGamma.Series["SeriesFeatureR"];
        Series seiresLines = chartGamma.Series["SeriesGammaR"];
    ...
    public void setGreenGammaArray(long[] pGamma, int index)
    {
        ...
        for (int i = 256 * index; i < 256 * (index + 1); i++)
        {
            _ = chartGamma.Series["SeriesGammaG"].Points.AddXY(num, pGamma[i]);
            num++;
        }
    ...
    public void setBlueGammaArray(long[] pGamma, int index)
    {
        ...
        for (int i = 256 * index; i < 256 * (index + 1); i++)
        {
            _ = chartGamma.Series["SeriesGammaB"].Points.AddXY(num, pGamma[i]);
            num++;
        }
    ...
    private void btnLoad_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < 768; i++)
        {
            if (i is >= 0 and <= 255)
            {
                _ = chartGamma.Series["SeriesGammaR"].Points.AddXY(i, array[i]);
            }
            else if (i is >= 256 and <= 511)
            {
                _ = chartGamma.Series["SeriesGammaG"].Points.AddXY(i - 256, array[i]);
            }
            else if (i is >= 512 and <= 767)
            {
                _ = chartGamma.Series["SeriesGammaB"].Points.AddXY(i - 512, array[i]);
            }
        }
        m_ptFeatureR.Clear();
        ...
        _ = chartGamma.Series["SeriesFeatureR"].Points.AddXY(0.0, chartGamma.Series["SeriesGammaR"].Points[0].YValues[0]);
        _ = chartGamma.Series["SeriesFeatureR"].Points.AddXY(255.0, chartGamma.Series["SeriesGammaR"].Points[255].YValues[0]);
        m_ptFeatureG.Clear();
        ...
        _ = chartGamma.Series["SeriesFeatureG"].Points.AddXY(0.0, chartGamma.Series["SeriesGammaG"].Points[0].YValues[0]);
        _ = chartGamma.Series["SeriesFeatureG"].Points.AddXY(255.0, chartGamma.Series["SeriesGammaG"].Points[255].YValues[0]);
        m_ptFeatureB.Clear();
        ...
        _ = chartGamma.Series["SeriesFeatureB"].Points.AddXY(0.0, chartGamma.Series["SeriesGammaB"].Points[0].YValues[0]);
        _ = chartGamma.Series["SeriesFeatureB"].Points.AddXY(255.0, chartGamma.Series["SeriesGammaB"].Points[255].YValues[0]);
        UpdateLineControl();
        SaveGammaValue_temp();
        streamReader.Close();
    }
    ...
    private void ResetCurve(string strGammaName)
    {
        ...
        if (pGammaArray != null)
        {
            ...
            {
                _ = chartGamma.Series[strGammaName].Points.AddXY(num, pGammaArray[num].Y);
            }
