...
public class FormLiveView : Form
{
    ...
    public Process m_ffplayLiveView = new();

    public Process m_ffmpegLiveView = new();

    public Process m_ffmpegCapturePictureView = new();

    public Process m_ffmpegVideoCaptureContiPictureView = new();

    private readonly int m_nTimeOutNum = 50;
    ...
    private void FFplayStart()
    {
        ...
        if (File.Exists(text))
        {
            ...
            RECT rect = default;
            _ = User32.GetWindowRect(m_ffplayLiveView.MainWindowHandle, ref rect);
        ...
        {
            _ = MessageBox.Show("There is no ffplay.exe file in <Bin> folder.", "Live View", MessageBoxButtons.OK, MessageBoxIcon.Hand);
        }
    }
    ...
    public static Bitmap PrintInactiveWindow(IntPtr hwnd)
    {
        ...
        _ = Gdi32.SelectObject(hDC, intPtr);
        _ = User32.PrintWindow(hwnd, hDC, PW_CLIENTONLY);
        _ = User32.OpenClipboard(IntPtr.Zero);
        _ = User32.EmptyClipboard();
        _ = User32.SetClipboardData(CF_BITMAP, intPtr);
        _ = User32.CloseClipboard();
        Bitmap result = Image.FromHbitmap(intPtr);
        _ = Gdi32.DeleteDC(hDC);
        _ = Gdi32.DeleteObject(intPtr);
        _ = User32.ReleaseDC(IntPtr.Zero, dC);
        return result;
    }

    public static Bitmap PrintWindow(IntPtr hwnd)
    {
        _ = User32.GetClientRect(hwnd, out RECT lpRect);
        int num = lpRect.right - lpRect.left;
        int num2 = lpRect.bottom - lpRect.top;
        Bitmap bitmap = new(num, num2, PixelFormat.Format32bppArgb);
    ...
    private void SetOriginalScreen()
    {
        if (m_bLiveViewStart && m_ffplayLiveView.MainWindowHandle != IntPtr.Zero)
        {
            ...
            _ = User32.MoveWindow(m_ffplayLiveView.MainWindowHandle, -num4, -num5, m_nLiveViewWidth, m_nLiveViewHeight, bRepaint: true);
        }
    }
    ...
    private void FitToScreen()
    {
        if (m_bLiveViewStart && m_ffplayLiveView.MainWindowHandle != IntPtr.Zero)
        {
            ...
            _ = User32.MoveWindow(m_ffplayLiveView.MainWindowHandle, -num4, -num5, nWidth, nHeight, bRepaint: true);
    ...
    private void VideoCaptureStart()
    {
        ...
        if (File.Exists(text2))
        {
            ...
            _ = m_ffmpegLiveView.Start();
            m_bVedioCaptureStart = true;
        }
        else
        {
            _ = MessageBox.Show("There is no ffmpeg.exe file in <Bin> folder.", "Live View", MessageBoxButtons.OK, MessageBoxIcon.Hand);
        }
    }
    ...
    private void btnStartLiveView_Click(object sender, EventArgs e)
    {
        ...
        {
            _ = MessageBox.Show("Please check connection", "Live View", MessageBoxButtons.OK);
            return;
        }
        ...
        {
            FFplayStop();
            btnStartLiveView.Image = ExtensionMethods.GetImageByName("play.png");
            btnStartLiveView.Text = "Start";
        }
        else
        {
            FFplayStart();
            btnStartLiveView.Image = ExtensionMethods.GetImageByName("stop.png");
    ...
    private void btnCaptureImage_Click(object sender, EventArgs e)
    {
        ...
        if (m_bLiveViewStart && m_ffplayLiveView.MainWindowHandle != IntPtr.Zero)
        {
            _ = User32.SetParent(m_ffplayLiveView.MainWindowHandle, IntPtr.Zero);
            _ = User32.MoveWindow(m_ffplayLiveView.MainWindowHandle, 0, 0, m_nLiveViewWidth, m_nLiveViewHeight, bRepaint: true);
            string text = Application.StartupPath + Settings.Default.SaveFolder;
            if (!Directory.Exists(text))
            {
                _ = Directory.CreateDirectory(text);
            ...
            _ = User32.SetParent(m_ffplayLiveView.MainWindowHandle, panelLiveView.Handle);
            SetLiveViewWindow();
        }
    }
    ...
    private void btnVideo_Click(object sender, EventArgs e)
    {
        ...
        {
            VideoCaptureStop();
            btnVideo.Image = ExtensionMethods.GetImageByName("videoCamera.png");
            btnVideo.Text = "video save start";
        }
        else
        {
            VideoCaptureStart();
            btnVideo.Image = ExtensionMethods.GetImageByName("videoStop.png");
    ...
    private void VideoImageContiCaptureStart()
    {
        ...
        if (File.Exists(text2))
        {
            ...
            _ = m_ffmpegVideoCaptureContiPictureView.Start();
    ...
    private void ContinuousCaptureImg()
    {
        ...
        if (File.Exists(text2))
        {
            ...
            _ = m_ffmpegCapturePictureView.Start();
    ...
    private void btnContinuousCapture_Click(object sender, EventArgs e)
    {
        ...
        if (m_bContinuousCaptureStart)
        {
            ...
            btnContinuousCapture.Image = ExtensionMethods.GetImageByName("continuousCapture.png");
            btnContinuousCapture.Text = "continuous capture frame image start";
        }
        else
        {
            ContinuousCaptureImg();
            btnContinuousCapture.Image = ExtensionMethods.GetImageByName("continuousStop.png");
    ...
    private void LoadImagetoolStripButton_Click(object sender, EventArgs e)
    {
        ...
        OpenFileDialog openFileDialog = new()
        {
            Title = "Open the img file you wish",
    ...
    {
        _ = captureImagepictureBox.Focus();
    ...
    {
        number = number / 5 * 5;
        return number <= 50 ? 5 : number <= 100 ? 10 : number <= 200 ? 25 : 50;
    }
    ...
    private void InitializeComponent()
    {
        ...
        btnStartLiveView.Image = ExtensionMethods.GetImageByName("btnStartLiveView.png");
        ...
        btnCaptureImage.Image = ExtensionMethods.GetImageByName("btnCaptureImage.png");
        ...
        btnVideo.Image = ExtensionMethods.GetImageByName("btnVideo.png");
        ...
        VideoImagetoolStripButton.Image = ExtensionMethods.GetImageByName("videoImagetool.png");
        ...
        btnContinuousCapture.Image = ExtensionMethods.GetImageByName("btnContinuousCapture.png");
        ...
        LoadImagetoolStripButton.Image = ExtensionMethods.GetImageByName("LoadImgtool.png");
        ...
        saveImgtoolStripButton.Image = ExtensionMethods.GetImageByName("saveImgtool.png");
