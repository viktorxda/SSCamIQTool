...
public class FormGlobalToneVer1 : Form
{
    ...
    private readonly GenGlobalTone m_objGlobalTone = new();

    private readonly long[] GlobalToneParam_Auto = new long[112];

    private readonly long[] GlobalToneParam_Manul = new long[7];
    ...
    private void initialGammaValue_ver1()
    {
        ...
        for (int i = 0; i < NumberOfGroup; i++)
        {
            ...
            GenGlobalTone genGlobalTone = new();
        ...
        GenGlobalTone genGlobalTone2 = new();
            ...
            case 1:
                {
                    ...
                    if (OpMode == 1)
                    {
                        ...
                        {
                            _ = chartWDR.Series["SeriesWDR"].Points.AddXY(num7, ynode_Manual[num7]);
                            _ = chartSimulatioWDR.Series["SimulationWDR"].Points.AddXY(xnode_Manual[num7], ynode_Manual[num7]);
                            _ = chartSimulatioWDR.Series["SimulationWDRFeature"].Points.AddXY(xnode_Manual[num7], ynode_Manual[num7]);
                        }
                    }
                    else
                    {
                        ...
                        {
                            _ = chartWDR.Series["SeriesWDR"].Points.AddXY(num8, ynode_Auto[(Index * FCurveNumber) + num8]);
                            _ = chartSimulatioWDR.Series["SimulationWDR"].Points.AddXY(xnode_Auto[(Index * FCurveNumber) + num8], ynode_Auto[(Index * FCurveNumber) + num8]);
                            _ = chartSimulatioWDR.Series["SimulationWDRFeature"].Points.AddXY(xnode_Auto[(Index * FCurveNumber) + num8], ynode_Auto[(Index * FCurveNumber) + num8]);
                        }
                    }
                    Series seiresPoints = chartWDR.Series["SeriesWDRFeature"];
                    Series seiresLines = chartWDR.Series["SeriesWDR"];
            ...
            case 0:
                {
                    ...
                    if (OpMode == 1)
                    {
                        for (int l = 0; l < 32; l++)
                        {
                            _ = chartSimulatioWDR.Series["SimulationWDR"].Points.AddXY(xnode_Manual[l], ynode_Manual[l]);
                            _ = chartSimulatioWDR.Series["SimulationWDRFeature"].Points.AddXY(xnode_Manual[l], ynode_Manual[l]);
                        }
                    }
                    else
                    {
                        for (int m = 0; m < 32; m++)
                        {
                            _ = chartSimulatioWDR.Series["SimulationWDR"].Points.AddXY(xnode_Auto[(Index * FCurveNumber) + m], ynode_Auto[(Index * FCurveNumber) + m]);
                            _ = chartSimulatioWDR.Series["SimulationWDRFeature"].Points.AddXY(xnode_Auto[(Index * FCurveNumber) + m], ynode_Auto[(Index * FCurveNumber) + m]);
                        }
                    }
                    break;
                }
